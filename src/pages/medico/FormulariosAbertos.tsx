...
interface JSONAbertos {
  ...
  focoInfeccioso: {
    ...
    infeccaoAbdominal: boolean,
    menigite: boolean,
    endocardite: boolean,
    pelePartesMoles: boolean,
    infeccaoProtese: boolean,
    infeccaoOssea: boolean,
    infeccaoFeridaOperatoria: boolean,
    infeccaoSanguineaCateter: boolean,
    semFocoDefinido: boolean,
    outrasInfeccoes: string
  },
  criterioExclusao: {
    apresentaCriterioExclusao: boolean,
    fimDeVida: boolean,
    doencaAtipica: boolean,
    probabilidadeSepseBaixa: boolean
  },
  bundleHora1: {
    iniciado: boolean,
    dtDisparo: Date,
    lactoDtColeta: Date,
    hemoculturaDtColeta: Date,
    antibioticoAmploAspectro: Date,
    cristaloides: boolean,
    vasopressores: boolean,
    justificativaNao: string
  },
  reavaliacoesSeriadas: {
    qSofa: boolean,
    pas100Mmghg: boolean,
    fr22Rpm: boolean,
    rebaixamentoNivelConsiencia: boolean,
    lactoInicialmenteAlto: boolean,
    outros: string,
    justificativaNao: string,
    aplicada: boolean
  }
