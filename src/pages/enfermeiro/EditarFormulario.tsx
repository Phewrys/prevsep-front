                        ...
                        <div className="row">
                            <div className="col-md-12 col-lg-5 m-2">
                              ...
                              <div className="form-group">
                                ...
                                <input type="text" className="form-control" id="idNomeCompleto" placeholder="Xxxxx Xxxxxx" required />
                              </div>
                              <div className="form-row">
                                <div className="col-md-6 mb-3">
                                  <label htmlFor="idIdade">Idade*</label>
                                  <input type="number" className="form-control" id="idIdade" placeholder="50" required />
                                </div>
                                <div className="col-md-6 mb-3">
                              ...
                              <div className="form-row">
                                <div className="col-md-6 mb-3">
                                  ...
                                  <input type="text" className="form-control" id="idLeitor" placeholder="xxxxx00000" required />
                                </div>
                                <div className="col-md-6 mb-3">
                                  <label htmlFor="idNAtendimento">Nº Atendimento*</label>
                                  <input type="text" className="form-control" id="idNAtendimento" placeholder="00000" required />
                                </div>
                              </div>
                              <div className="form-group">
                                <label htmlFor="idRegistro">Registro*</label>
                                <input type="text" className="form-control" id="idRegistro" placeholder="00000" required />
                              </div>
                            </div>
                            <div className="col-md-12 col-lg-5 m-2">
                              ...
                              <div className="form-check">
                                <input className="form-check-input" type="checkbox" value="" id="idEF11" checked />
                                <label className="form-check-label" htmlFor="idEF11">
                                  Febre {'>'} 37,8ºC ou hipotermia {'<'} 35ºC. 
                                </label>
                              </div>
                              <div className="form-check">
                                <input className="form-check-input" type="checkbox" value="" id="idEF12" checked />
                              ...
                              <div className="form-check">
                                <input className="form-check-input" type="checkbox" value="" id="idEF22" checked />
                                <label className="form-check-label" htmlFor="idEF22">
                                  Hipotensão (PAS &le; 90mmHg).
                                </label>
                              </div>
                              <div className="form-check">
                                <input className="form-check-input" type="checkbox" value="" id="idEF23" checked />
                        ...
                        <div className="row">
                            <div className="col-md-12 col-lg-5 m-2">
                              ...
                              <div className="form-row">
                                <div className="form-check col-md-5 ml-4">
                                  <input className="form-check-input" type="checkbox" value="" id="idClinicaMedica1" checked />
                                  <label className="form-check-label" htmlFor="idClinicaMedica1">Clínica Médica I</label>
                                </div>
                                <div className="form-check col-md-5 ml-4">
                                  <input className="form-check-input" type="checkbox" value="" id="idClinicaMedica2" checked />
                                ...
                                <div className="form-check col-md-5 ml-4">
                                  <input className="form-check-input" type="checkbox" value="" id="idClinicaCirurgica2" checked />
                                ...
                                <div className="form-check col-md-5 ml-4">
                                  <input className="form-check-input" type="checkbox" value="" id="idAmbulatório" checked />
                            ...
                            <div className="col-md-12 col-lg-5 m-2">
                              ...
                              <div className="form-group">
                                ...
                                <input type="text" className="form-control" id="idNomeMedicoChamado" placeholder="Xxxxx Xxxxx" required />
                              </div>
                            </div>
                        </div>
